...
function createPopupTemlate(movie) {
  ...
  function createCommentTemplate(comment) {
    const {text, date, author, emotion} = comment;
  ...
  const commentItemTemplate = comments
    .map((comment) => createCommentTemplate(comment))
    .join('');

  function createGenreTemplate(genre) {
    return (`<span class="film-details__genre">${genre}</span>`);
  }

  const genreItemTemplate = genres
  ...
  return `<form class="film-details__inner" action="" method="get">
      <div class="film-details__top-container">
        ...
        <section class="film-details__controls">
          <input type="checkbox" class="film-details__control-input  visually-hidden" id="watchlist" name="watchlist" ${isChecked(isAddWatchlist)}>
